...
function showMore() {
  ...
  function getHeight(showMoreBlock, showMoreContent) {
    console.log("=== SHOWMORE DEBUG ===");
    console.log("Total children:", showMoreContent.children.length);
    console.log("Content offsetHeight:", showMoreContent.offsetHeight);
    console.log("Content computed height:", getComputedStyle(showMoreContent).height);
    console.log("showMoreType:", showMoreBlock.dataset.flsShowmore);
    console.log("showMoreTypeValue:", showMoreContent.dataset.flsShowmoreContent);
    let hiddenHeight = 0;
